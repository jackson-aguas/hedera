...
public class AccountController {
	...
	public AccountInfo getAccount(@PathVariable(value = "accountId") String accountId)
			throws TimeoutException, ReceiptStatusException, PrecheckStatusException {
		return accountService.getAccount(accountId);
	}

	@GetMapping("/{accountId}/info")
	public AccountInfo getAccountInfo(@PathVariable(value = "accountId") String accountId)
			throws TimeoutException, ReceiptStatusException, PrecheckStatusException {
		return accountService.getAccount(accountId);
	}

	@GetMapping("/{accountId}/balance")
	public AccountBalance getAccountBalance(@PathVariable(value = "accountId") String accountId)
			throws TimeoutException, ReceiptStatusException, PrecheckStatusException {
	...
	public TransactionRecord transferHbar(@PathVariable(value = "accountId") String accountId,
			@RequestParam(value = "amount") long hbar)
			throws TimeoutException, ReceiptStatusException, PrecheckStatusException {
